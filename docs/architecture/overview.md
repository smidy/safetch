...
|---|---|---|
| `POST /fetch` | JSON body: `{ "url": "...", "sessionId": "..." }` | [api/post-fetch.md](../api/post-fetch.md) |
| `GET /fetch` | Query string: `?url=...&sessionId=...` | [api/get-fetch.md](../api/get-fetch.md) |
...
|---|---|
| `{ "success": true, "url": "...", "content": "...", "statusCode": 200, "sessionId": "...", "warnings": [] }` | `{ "success": false, "errorCode": "BLOCKED"\|"FETCH_FAILED", "errorMessage": "..." }` |

- Content is returned as Markdown (HTML pages are converted via ReverseMarkdown).
- `warnings` is always present — non-empty if injection patterns or Unicode Tag characters were detected.
- `sessionId` is optional on input; auto-generated by the pipeline if omitted.
